...
namespace FloorByPoint
{
    ...
    public class Command : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            tx.Start();
            #endregion
            //Model.XYZCoordinates pnt1 = new Model.XYZCoordinates()
            //{ X = 600567064.0.Milimet2Feet(), Y = 1194285538.0.Milimet2Feet() };
            //Model.XYZCoordinates pnt2 = new Model.XYZCoordinates()
            //{ X = 600562904.54.Milimet2Feet(), Y = 1194305576.87.Milimet2Feet() };
            //Model.XYZCoordinates pnt3 = new Model.XYZCoordinates()
            //{ X = 600585047.49.Milimet2Feet(), Y = 1194305870.11.Milimet2Feet() };
            //Model.XYZCoordinates pnt4 = new Model.XYZCoordinates()
            //{ X = 600584567.48.Milimet2Feet(), Y = 1194276648.20.Milimet2Feet() };

            Model.XYZCoordinates pnt1 = new Model.XYZCoordinates()
            { X = 600567064, Y = 1194285538 };

            Model.XYZCoordinates pnt2 = new Model.XYZCoordinates()
            { X = 600562904.54, Y = 1194305576.87 };
            Model.XYZCoordinates pnt3 = new Model.XYZCoordinates()
            { X = 600585047.49, Y = 1194305870.11 };
            Model.XYZCoordinates pnt4 = new Model.XYZCoordinates()
            { X = 600584567.48, Y = 1194276648.20 };

            Model.Entity.Floor floor = new Model.Entity.Floor();
            floor.XYZCoordinates.Add(pnt1);
            floor.XYZCoordinates.Add(pnt2);
            floor.XYZCoordinates.Add(pnt3);
            floor.XYZCoordinates.Add(pnt4);
            floor.CreateFloorByVN2000();
